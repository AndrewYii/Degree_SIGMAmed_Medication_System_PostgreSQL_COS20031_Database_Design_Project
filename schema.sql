...
-- Prescribed Medication Log Table
CREATE TABLE IF NOT EXISTS "PrescribedMedicationLog" (
    "LogId" UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
...
-- Search the Prescribed Medication Log table based on the id
CREATE INDEX idx_pmlog_prescribedmedication ON "PrescribedMedicationLog"("PrescribedMedicationId");

-- Add foreign key constraint to link Prescribed Medication Log to Prescribed Medication
ALTER TABLE "PrescribedMedicationLog" ADD CONSTRAINT "fk_prescribedmedicationlog_prescribedmedication" FOREIGN KEY ("PrescribedMedicationId") REFERENCES "PrescribedMedication"("PrescribedMedicationID");
-- Add foreign key constraint to link Prescribed Medication Log to User
ALTER TABLE "PrescribedMedicationLog" ADD CONSTRAINT "fk_pmlog_modify" FOREIGN KEY ("ActedBy") REFERENCES "User"("UserId");

COMMIT;
-- End of the Prescribed Medication Log Table creation
